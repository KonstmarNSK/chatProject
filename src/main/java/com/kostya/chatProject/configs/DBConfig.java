...
@ComponentScan(basePackages = {"com.kostya.chatProject.entities", "com.kostya.chatProject.repositories"})
public class DBConfig {
    ...
    public LocalSessionFactoryBean getSessionFactoryBean(DataSource dataSource){
        ...
        sessionFactoryBean.setPackagesToScan("com.kostya.chatProject.entities");
